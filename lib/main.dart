...
final List<Medicament> kMedicaments = [
  const Medicament(
    ...
    description: 'Antalgique et antipyrétique. Soulage la douleur et la fièvre.',
...
class _SplashScreenState extends State<SplashScreen>
  ...
  void initState() {
    ...
    Future.delayed(const Duration(milliseconds: 800), () => _progressCtrl.forward());
                    ...
                    AnimatedBuilder(
                      ...
                      builder: (_, __) => ClipRRect(
                        ...
                        child: LinearProgressIndicator(
                          ...
                          valueColor:
                              const AlwaysStoppedAnimation<Color>(kOr),
                          minHeight: 4,
                        ),
                      ),
                    ),
...
class _AuthScreenState extends State<AuthScreen>
  ...
  void _register() async {
    if (_regNomCtrl.text.isEmpty || _regEmailCtrl.text.isEmpty ||
...
class _AccueilPageState extends State<AccueilPage> {
  ...
  double _sadaqaTotal = 127500;
  double _sadaqaObjectif = 500000;
  int _orphelins = 23;
  int _familles = 8;
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                          child: _statCard('$_orphelins', 'Orphelins\naidés',
                              '🧒', kVert)),
                      const SizedBox(width: 12),
                      Expanded(
                          child: _statCard('$_familles', 'Familles\nvulnérables',
                              '👨‍👩‍👧', kBleu)),
                    ],
                  ),
                  const SizedBox(height: 20),
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              const Text('Collecte mensuelle',
                  style: TextStyle(
                      ...
                      fontWeight: FontWeight.bold)),
              Text('${(pct * 100).round()}%',
                  style: const TextStyle(color: kOr, fontSize: 16,
                      fontWeight: FontWeight.bold)),
            ],
          ),
          const SizedBox(height: 8),
          Text(
            ...
            style: TextStyle(
                color: kBlanc.withValues(alpha: 0.85), fontSize: 13),
          ),
          const SizedBox(height: 12),
          ClipRRect(
...
class _PaiementSheetState extends State<PaiementSheet> {
  ...
  void _payer() async {
    if (_montantCtrl.text.isEmpty || _telCtrl.text.isEmpty) {
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text('Remplissez tous les champs')));
      return;
    }
    setState(() => _loading = true);
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon:
                  const Icon(Icons.phone_outlined, color: kVert),
              border: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(12)),
            ),
          ),
...
class _SantePageState extends State<SantePage>
            ...
            child: const Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                      color: kGris, fontSize: 13, fontStyle: FontStyle.italic,
                      height: 1.5),
                ),
                SizedBox(height: 4),
                Text('— Tirmidhi',
      ...
      children: [
        Row(
          ...
          children: [
            ...
            Text('${val.round()} $unit',
                style: const TextStyle(
                    color: kVert, fontWeight: FontWeight.bold)),
          ],
        ),
        Slider(
          value: val,
  ...
  final List<String> _categories = [
    'Tous', 'Antalgiques', 'Antibiotiques', 'Antipaludéens',
    'Vitamines', 'Médecine Prophétique', 'Pédiatrie', 'Antidiabétiques'
  ];
    ...
    final articles = [
      {
        ...
        'resume': 'Comment protéger votre famille avec des méthodes naturelles et médicales...',
        'emoji': '🦟',
        'temps': '5 min',
      },
      {
        'titre': 'La nigelle (Habba Sawda) : vertus médicales prouvées',
        'resume': 'La science confirme les bienfaits de cette plante mentionnée dans la Sunna...',
        'emoji': '🌿',
        'temps': '7 min',
      },
      {
        'titre': 'Diabète et Ramadan : conseils pratiques',
        'resume': 'Tout ce que vous devez savoir pour jeûner en toute sécurité...',
        'emoji': '🩸',
        'temps': '8 min',
      },
      {
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon:
                    const Icon(Icons.home_outlined, color: kVert),
                border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(12)),
              ),
            ),
            ...
            Wrap(
              spacing: 8,
              children: ['Orange Money', 'Moov Money', 'Wave', 'Banque']
                  .map((m) {
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(10),
                      border: Border.all(
                          color: sel ? kVert : Colors.transparent,
                          width: 2),
                    ),
                    child: Text(m,
                        style: TextStyle(
                    ...
                    : () async {
                        if (_adresseCtrl.text.isEmpty ||
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                                content:
                                    Text('Remplissez l\'adresse et le téléphone')),
                          );
                          return;
                        }
                        setState(() => _loading = true);
...
class _ConsultationPageState extends State<ConsultationPage> {
  ...
  final List<String> _specialites = [
    'Tous', 'Médecin Généraliste', 'Pédiatre',
    'Cardiologue', 'Gynécologue', 'Ophtalmologue'
  ];
  ...
  Widget build(BuildContext context) {
    final filtered = _specialite == 'Tous'
        ? kMedecins
        : kMedecins
            .where((m) => m.specialite == _specialite)
            .toList();
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (_, i) {
                ...
                return GestureDetector(
                  onTap: () =>
                      setState(() => _specialite = _specialites[i]),
                  child: Container(
                    margin: const EdgeInsets.only(right: 8),
                    padding: const EdgeInsets.symmetric(horizontal: 14),
                    decoration: BoxDecoration(
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              spacing: 8,
              children:
                  ['Orange Money', 'Moov Money', 'Wave', 'Banque']
                      .map((m) {
                final sel = _methode == m;
                return GestureDetector(
                  onTap: () => setState(() => _methode = m),
...
class QuranTab extends StatelessWidget {
  ...
  static const List<Map<String, dynamic>> _surahs = [
    {'num': 1,  'nom': 'Al-Fatiha',    'ar': 'الفاتحة',   'versets': 7,   'type': 'Mecquoise'},
    {'num': 2,  'nom': 'Al-Baqara',    'ar': 'البقرة',    'versets': 286, 'type': 'Médinoise'},
    {'num': 3,  'nom': 'Al-Imran',     'ar': 'آل عمران',  'versets': 200, 'type': 'Médinoise'},
    {'num': 4,  'nom': 'An-Nisa',      'ar': 'النساء',    'versets': 176, 'type': 'Médinoise'},
    {'num': 5,  'nom': 'Al-Maida',     'ar': 'المائدة',   'versets': 120, 'type': 'Médinoise'},
    {'num': 36, 'nom': 'Ya-Sin',       'ar': 'يس',        'versets': 83,  'type': 'Mecquoise'},
    {'num': 67, 'nom': 'Al-Mulk',      'ar': 'الملك',     'versets': 30,  'type': 'Mecquoise'},
    {'num': 112,'nom': 'Al-Ikhlas',    'ar': 'الإخلاص',   'versets': 4,   'type': 'Mecquoise'},
    {'num': 113,'nom': 'Al-Falaq',     'ar': 'الفلق',     'versets': 5,   'type': 'Mecquoise'},
    {'num': 114,'nom': 'An-Nas',       'ar': 'الناس',     'versets': 6,   'type': 'Mecquoise'},
  ];
            ...
            Container(
              ...
              child: Column(
                children: [
                  Text(surah['ar'],
                      style: const TextStyle(
                          color: kOr, fontSize: 28)),
                  const SizedBox(height: 8),
                  Text(surah['nom'],
                      style: const TextStyle(
                          color: kBlanc, fontSize: 18)),
                  Text('${surah['versets']} versets',
                      style: TextStyle(
                          color: kBlanc.withValues(alpha: 0.7),
                          fontSize: 13)),
                ],
              ),
            ),
              ...
              Row(
                children: [
                  Container(
                    ...
                    height: 36,
                    decoration: const BoxDecoration(
                        color: kOr, shape: BoxShape.circle),
                    child: Center(
                      child: Text(h['num']!,
                          style: const TextStyle(
                              color: kVert,
...
class _DhikrTabState extends State<DhikrTab> {
  ...
  final List<Map<String, String>> _dhikrs = [
    ...
    {'ar': 'لَا إِلَهَ إِلَّا اللَّه', 'fr': 'Pas de divinité sauf Allah', 'obj': '100'},
    {'ar': 'أَسْتَغْفِرُ اللَّه', 'fr': 'Je demande pardon à Allah', 'obj': '100'},
  ];
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 6),
          Text(_traduction,
              style: const TextStyle(color: kGris, fontSize: 14)),
          const SizedBox(height: 20),
          ClipRRect(
            borderRadius: BorderRadius.circular(8),
            child: LinearProgressIndicator(
